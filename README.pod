...
This is Perl module B<File::Find::Rule::ConflictMarker>.
...
File::Find::Rule::ConflictMarker installation is straightforward. If your CPAN shell is set up,
you should just be able to do

    % cpan File::Find::Rule::ConflictMarker
...
File::Find::Rule::ConflictMarker documentation is available as in POD. So you can do:

    % perldoc File::Find::Rule::ConflictMarker


=head1 REPOSITORY

File::Find::Rule::ConflictMarker is hosted on github
L<http://github.com/bayashi/File-Find-Rule-ConflictMarker>
